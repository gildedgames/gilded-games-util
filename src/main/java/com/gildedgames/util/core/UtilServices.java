...
public class UtilServices
{
	...
	private void startIOManager()
	{
		...
		registry.registerClass(UIFrame.class, 4);
		...
		registry.registerClass(BasicUI.class, 19);
		registry.registerClass(AbstractUI.class, 20);
		registry.registerClass(TestUI.class, 21);
		registry.registerClass(UIElementContainer.class, 22);
