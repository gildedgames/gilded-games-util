...
public class TLTransformer implements IClassTransformer
{
	...
	public byte[] transform(String name, String transformedName, byte[] bytes)
	{
		...
		if (transformedName.equals(MCP_CHUNK))
		{
			...
			MethodNode setBlockState = this.findMethod(classNode, "func_177436_a", "(Lnet/minecraft/util/BlockPos;Lnet/minecraft/block/state/IBlockState;)Lnet/minecraft/block/state/IBlockState;");
