...
public class Instantiator implements Callable<Object>
{
	...
	public Object call()
	{
		try
		{
			...
			if (inst == null)
			{
				throw new NullPointerException("Something went wrong trying to create an instance of " + this.clazz.getName() + ". Most likely you forgot to create an empty constructor for it.");
			}
